...
public class SelectSystem : MonoBehaviour
{
    ...
    public string lostItemname;                                     // P긴 or 소실한 아이템 이름
    public string changeItemname; 
    public int lostItemNum;                                     // P긴 or 소실한 아이템 이름
    ...
    public void Beggar()
    {
        ...
        popupPanel.SetActive(true);
        //getGoldPanel.SetActive(true);
        //getGoldPanel.transform.GetChild(1).GetComponent<Text>().text = num+100 + "골드를 득하였다."; 
